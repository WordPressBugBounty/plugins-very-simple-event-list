...
$vsel_start_label = get_option( 'vsel-setting-23' );
$vsel_end_label = get_option( 'vsel-setting-24' );
...
$vsel_image_location = get_option( 'vsel-setting-37' );
...
$vsel_meta_start = '<div class="vsel-meta vsel-alignleft" style="width:100%; box-sizing:border-box;">';
$vsel_meta_end = '</div>';

// set event info container
$vsel_info_start = '<div class="vsel-info vsel-alignleft" style="width:100%; box-sizing:border-box;">';
$vsel_info_end = '</div>';
